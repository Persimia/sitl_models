...
xterm -e "GZ_SIM_RESOURCE_PATH=/home/skemp32/ros2_ws/src/sitl_models/models:\$GZ_SIM_RESOURCE_PATH; gz sim -v4 -r /home/skemp32/ros2_ws/src/sitl_models/worlds/turbine_suction.sdf; exec bash" &
