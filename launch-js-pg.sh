...
xterm -e "cd /home/skemp32/ros2_ws/src/sitl_models/doe-pd-data; sim_vehicle.py -v ArduCopter --model=json -G -D -M --add-param-file=/home/skemp32/ros2_ws/src/sitl_models/config/gazebo-doe.parm --speedup=1 --slave=0 --sim-address=127.0.0.1 --instance=0 --enable-dds --console -A --synthetic-clock -A --serial5=sim:sf45b; exec bash" &
